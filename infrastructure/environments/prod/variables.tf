...
# These variables are defined in the parent infrastructure/variables.tf
# This file re-declares them for the environment-specific Terraform context
...
variable "lambda_code_path" {
  description = "Path to Lambda function code zip file"
  type        = string
}
